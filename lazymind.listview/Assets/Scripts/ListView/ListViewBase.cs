...
public class ListViewBase<TYPE> where TYPE : ListViewData
{
    ...
    SimpleGameObjectPool GameObjectPool { get; set; }
    ...
    protected void Init(RectTransform _rectTransform, ObservableList<TYPE> _dataProvider)
    {
        ...
        GameObjectPool = new SimpleGameObjectPool();
    }
    ...
    void ClearQueue()
    {
        foreach (var kv in ListItemInfoQueueByPrefab)
        {
            ...
            {
                info.ListItem.Clear();
                GameObjectPool.Release(info.ListItem.gameObject);
            }
        }
    ...
    protected void InvalidateListItem(TYPE _data)
    {
        ...
        CalcListItemPosition(_data, out anchoredPosition);
        ...
        {
            GameObject go = GameObjectPool.Get(_data.Prefab);
    ...
    protected virtual void CalcListItemPosition(TYPE _data, out Vector2 _anchoredPosition)
    {
